...
void loop()
{
  ...
  for (int i=0; i<LED_COUNT*10; i++)
  {
    ...
    //rainbowBrightness(i, 50);
    rainbowBrightness(i, 250);
    delay(2400);  // Delay between rainbow slides
  }
  ...
  /*for (int i=0; i<20; i++)
  {
    ...
    cascade(MEDIUMSPRINGGREEN, TOP_DOWN, 1000);
  }*/
}
...
void rainbowBrightness(byte startPosition, byte theBrightness)
{
  // Need to scale our rainbow. We want a variety of colors, even if there
  // are just 10 or so pixels.
  int rainbowScale = 192 / LED_COUNT * 3;
  ...
  for (int i=0; i<LED_COUNT; i++)
  {
    ...
    // set the brightness a little lower
    leds.setBrightness(theBrightness);
  }
